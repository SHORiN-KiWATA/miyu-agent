...
pub(in crate::web) async fn index_asset(
    ...
    static VERSIONED_INDEX: std::sync::LazyLock<String> = std::sync::LazyLock::new(|| {
        let mut html = INDEX_HTML
            .replace(
                "href=\"/styles.css\"",
                &format!("href=\"/styles.css?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/app.js\"",
                &format!("src=\"/app.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/commands.js\"",
                &format!("src=\"/commands.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/lightbox.js\"",
                &format!("src=\"/lightbox.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/preview.js\"",
                &format!("src=\"/preview.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/linkcards.js\"",
                &format!("src=\"/linkcards.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
                "src=\"/todos.js\"",
            ...
            .replace(
                "src=\"/highlight.js\"",
                &format!("src=\"/highlight.js?v={}\"", miyu_base::build_id()),
            )
            .replace(
        ...
        for (name, _) in DASH_SCRIPTS {
            html = html.replace(
                ...
                &format!("src=\"/dash/{name}?v={}\"", miyu_base::build_id()),
            );
        }
        html
    });
...
pub(in crate::web) async fn subagents_js_asset(headers: HeaderMap) -> Response {
    embedded_asset(
        &headers,
        SUBAGENTS_JS.as_bytes(),
        "application/javascript; charset=utf-8",
    )
}
...
static DASH_SCRIPTS: &[(&str, &str)] = &[
    (
        "dashboards.js",
        include_str!("../../../../web/dashboards.js"),
    ),
    (
        "dash-memory.js",
        include_str!("../../../../web/dash-memory.js"),
    ),
    ("dash-kb.js", include_str!("../../../../web/dash-kb.js")),
    (
        "dash-memes.js",
        include_str!("../../../../web/dash-memes.js"),
    ),
    ("dash-qq.js", include_str!("../../../../web/dash-qq.js")),
    (
        "dash-groups.js",
        include_str!("../../../../web/dash-groups.js"),
    ),
    (
        "dash-affection.js",
    ...
    (
        "dash-scripts.js",
        include_str!("../../../../web/dash-scripts.js"),
    ),
    (
        "dash-ledger.js",
        include_str!("../../../../web/dash-ledger.js"),
    ),
    (
    ...
    (
        "dash-sponsor.js",
        include_str!("../../../../web/dash-sponsor.js"),
    ),
