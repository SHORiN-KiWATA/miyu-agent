...
pub struct PlatformCommandDescriptor {
    pub id: &'static str,
    pub default_permission: PlatformCommandPermission,
}

pub const BUILTIN_COMMANDS: &[PlatformCommandDescriptor] = &[
...
mod tests {
    use super::*;
    use miyu_base::config::{PlatformCommandConfig, PlatformsConfig};
