...
pub(crate) struct TurnResources {
    ...
    pub(crate) normal_tools: miyu_engine::tools::ToolRegistry,
    pub(crate) dev_tools: miyu_engine::tools::ToolRegistry,
    pub(crate) restricted_tools: miyu_engine::tools::ToolRegistry,
}
...
impl TurnResourceCache {
    ...
    pub(crate) fn get_or_build(
        ...
        let restricted_tools = if config.tools.enabled {
            miyu_engine::tools::restricted_platform_registry(config, paths)
        } else {
            miyu_engine::tools::ToolRegistry::new()
        };
...
impl WebIdentity {
    ...
    pub(crate) fn from_account(account: &miyu_core::state::Account) -> Self {
        Self {
...
impl WebAuth {
    ...
    fn persist(&self) {
        ...
        if let Err(error) = miyu_core::ipc::write_private_state(path, text.as_bytes()) {
