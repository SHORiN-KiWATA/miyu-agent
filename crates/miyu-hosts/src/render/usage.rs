...
pub fn token_usage_output(meter: &TokenMeter, estimated: bool) -> String {
...
pub fn format_token_usage_inline(meter: &TokenMeter) -> String {
    format_token_usage_inline_opts(meter, true, true)
}

pub fn format_token_usage_inline_opts(
    meter: &TokenMeter,
    show_percent: bool,
    show_speed: bool,
) -> String {
